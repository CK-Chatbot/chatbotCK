...
class BedrockStack(Stack):
    ...
    ## action group
        action_group_function = PythonFunction(
            ...
            entry= os.path.join(os.path.dirname(__file__), '../action-group/'),
        ...
        ag = bedrock.AgentActionGroup(
                ...
                description= 'Use these functions to get information about Cloud Kinetics company in that knowledge base and www.cloud-kinetics.com',
     ...
     ## agent 
        agent = bedrock.Agent(
            ...
            instruction="You are a helpful and friendly agent that answers questions about inquiries (FaQs, services offerings,...) related to Cloud Kinetics Company",
            knowledge_bases=[kb],
